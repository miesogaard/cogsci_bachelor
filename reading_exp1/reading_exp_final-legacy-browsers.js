...
function firstWelcomeRoutineBegin(snapshot) {
  return function () {
    ...
    firstWelcomeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function confirmationFormRoutineBegin(snapshot) {
  return function () {
    ...
    confirmationFormComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function questionsLoopLoopBegin(questionsLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  questionsLoop.forEach(function() {
...
function showStory_2RoutineBegin(snapshot) {
  return function () {
    ...
    showStory_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function afterStoryRoutineBegin(snapshot) {
  return function () {
    ...
    afterStoryComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function showQuestionsRoutineBegin(snapshot) {
  return function () {
    ...
    showQuestionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function afterQuestionsRoutineBegin(snapshot) {
  return function () {
    ...
    afterQuestionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function extraCodeRoutineBegin(snapshot) {
  return function () {
    ...
    extraCodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
